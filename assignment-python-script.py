...
# File_name = wisdom-Phython-script.py
# Matric number = ENV2303968

# Problem 1
print('===== problem 1: Variable and Data Type =====')
city_name = "Lagos"
population = 15000000
...
print("Population Density: ", population_density, " people per km²")
